...
# stranded! Unfortunately, you don't have your watch on you and don't know what time it is. All you know thanks to the bike's timer is that n minutes have passed since 00:00.
...
def lateRide(n):
  ...
  return int(hours[0]) + int(hours[1]) + int(mins[0]) + int(mins[1])
